        ...
        <div class="row">
          ...
          <div class="col-md-4 well">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="contactno" name="contactno" placeholder="Contact Number" minlength="11" maxlength="11" autocomplete="off" onkeypress="return validatePhone(event);" required="" value="<?php echo $row['contactno']; ?>">
              </div>
              <div class="form-group">
